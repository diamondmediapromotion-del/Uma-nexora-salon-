...
export default function DistrictExpansion() {
  ...
  return (
    <div className="space-y-6">
                ...
                <div className="border-t border-slate-100 pt-4 space-y-2">
                  ...
                  <div className="flex gap-2">
                    ...
                    >
                      ...
                      <option value="pilot_active">{(launches.find(l => l.district_name === 'Ajmer')?.launch_status === 'scale_active' ? 'Scale Active' : 'Pilot Active')}</option>
      ...
      {/* Sub-tab 9: Ajmer Pilot Execution */}
      {subTab === "ajmer_pilot" && (
        <div className="space-y-6">
          <div className="p-4 rounded-3xl border border-blue-100 bg-blue-50/50 flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            {launches.find(l => l.district_name === 'Ajmer')?.launch_status === 'pilot_active' || launches.find(l => l.district_name === 'Ajmer')?.launch_status === 'scale_active' ? (
              <span className="px-4 py-2 bg-emerald-100 border border-emerald-200 text-emerald-800 text-xs font-black uppercase tracking-wider rounded-xl flex items-center gap-2">
                ...
                {(launches.find(l => l.district_name === 'Ajmer')?.launch_status === 'scale_active' ? 'Scale Active' : 'Pilot Active')}
              </span>
            ) : (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-white rounded-3xl border border-slate-100 p-6 shadow-2xs space-y-4">
              <h3 className="text-sm font-black text-slate-900 uppercase tracking-wider">7-Day Reports Overview</h3>
              <div className="overflow-x-auto">
                <table className="w-full text-left text-xs">
                  <thead>
            ...
            <div className="bg-white rounded-3xl border border-slate-100 p-6 shadow-2xs space-y-4">
              ...
              <div className="pt-2">
                 <button onClick={() => setSubTab("incidents")} className="text-xs font-bold text-blue-600 hover:text-blue-700 transition-colors w-full text-center py-2">
                   Manage All Incidents &rarr;
                 </button>
              </div>
            </div>
          </div>
